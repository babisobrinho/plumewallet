    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-3">
                ...
                {{-- Link para Nova Rendimento --}}
                <a href="{{ route('incomes.create') }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-600 to-green-700 border border-transparent rounded-md font-semibold
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-2">
                                            ...
                                            <a href="{{ route('incomes.show', $transaction->id) }}"
            ...
            @else
                ...
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 mb-6">
                        Comece registando o seu primeiro rendimento.
                    </p>
