<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-2">
                ...
                {{-- Link para Editar Rendimento --}}
                <a href="{{ route('incomes.edit', $transaction->id) }}"
    ...
    <div class="py-12 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-gray-800 dark:to-gray-900">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <!-- Cartão Principal do Rendimento -->
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg mb-8 border-l-4 border-green-600">
                <div class="p-8">
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center">
                            <div class="w-16 h-16 rounded-full flex items-center justify-center text-white mr-6 bg-green-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <dl class="space-y-4">
                            <div>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Data do Rendimento</dt>
            ...
            <div class="mt-8 flex justify-center space-x-4">
                ...
                {{-- Formulário para Remover Rendimento --}}
                <form action="{{ route('incomes.destroy', $transaction->id) }}" method="POST" class="inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
                            onclick="return confirm('Tem certeza que deseja remover este rendimento?')"
