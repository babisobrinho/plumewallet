<x-slot name="header">
    <x-backoffice-header
        ...
        subtitle="Atualizar dados do utilizador"
    />
</x-slot>
    ...
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
            <form wire:submit="save" class="p-6 space-y-6">
                ...
                <!-- Palavra-passe -->
                <div>
                    <x-label for="password" value="Nova Palavra-passe (deixe em branco para manter a atual)" />
                    <x-input 
                        id="password" 
                        type="password" 
                        class="mt-1 block w-full" 
                ...
                @if($password)
                    <div>
                        <x-label for="password_confirmation" value="Confirmar Nova Palavra-passe" />
                        <x-input 
                ...
                <div class="flex items-center">
                    ...
                    <label for="is_active" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">
                        Utilizador ativo (email verificado)
                    </label>
                </div>
