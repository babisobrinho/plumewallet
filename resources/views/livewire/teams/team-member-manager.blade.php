<div>
        ...
        <div class="mt-10 sm:mt-0">
            <x-form-section submit="addTeamMember">
                ...
                <x-slot name="description">
                    {{ __('Add a new space member to your space, allowing them to collaborate with you.') }}
                </x-slot>

                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
                            {{ __('Please provide the email address of the person you would like to add to this space.') }}
                        </div>
                    </div>
    ...
    @if ($team->teamInvitations->isNotEmpty() && Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-action-section>
                <x-slot name="title">
                    {{ __('Pending Space Invitations') }}
                </x-slot>

                <x-slot name="description">
                    {{ __('These people have been invited to your space and have been sent an invitation email. They may join the space by accepting the email invitation.') }}
                </x-slot>
    ...
    @if ($team->users->isNotEmpty())
        ...
        <div class="mt-10 sm:mt-0">
            <x-action-section>
                ...
                <x-slot name="description">
                    {{ __('All of the people that are part of this space.') }}
                </x-slot>
    ...
    <x-confirmation-modal wire:model.live="confirmingLeavingTeam">
        ...
        <x-slot name="content">
            {{ __('Are you sure you would like to leave this space?') }}
        </x-slot>
    ...
    <x-confirmation-modal wire:model.live="confirmingTeamMemberRemoval">
        <x-slot name="title">
            {{ __('Remove Space Member') }}
        </x-slot>

        <x-slot name="content">
            {{ __('Are you sure you would like to remove this person from the space?') }}
        </x-slot>
