...
<body class="min-h-screen bg-gray-100 font-sans antialiased">
    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 bg-gray-800 relative flex items-center justify-center p-8">
            ...
            <div class="absolute inset-0 bg-gray-300" style="clip-path: polygon(100% 0, 20% 0, 0% 50%, 20% 100%, 100% 100%);"></div>
            ...
            <div class="relative z-10 text-center text-gray-900 px-8">
                ...
                <a href="{{ route('login') }}" class="inline-block bg-gray-800 text-white font-semibold py-3 px-8 rounded-lg hover:bg-gray-700 transition-colors">
                    Entrar
                </a>
            </div>
        </div>
