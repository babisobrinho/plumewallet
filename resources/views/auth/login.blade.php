...
<body class="min-h-screen bg-gray-100 font-sans antialiased">
    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 bg-gray-100 relative flex items-center justify-center p-8">
            ...
            <div class="absolute inset-0 bg-gray-800" style="clip-path: polygon(0 0, 80% 0, 100% 50%, 80% 100%, 0 100%);"></div>
            ...
            <div class="relative z-10 text-center text-white px-8">
                ...
                <a href="{{ route('register') }}" class="inline-block bg-white text-gray-800 font-semibold py-3 px-8 rounded-lg hover:bg-gray-100 transition-colors">
