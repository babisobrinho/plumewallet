<div class="w-64 bg-gray-900 text-white dark:bg-gray-900 dark:text-gray-100">
    ...
    <nav class="mt-6">
        <!-- PRINCIPAL Section -->
        <div class="px-4 mb-4">
            <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">PRINCIPAL</h3>
            <div class="space-y-1">
        ...
        <!-- GESTÃO Section -->
        <div class="px-4 mb-4">
            <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">GESTÃO</h3>
            <div class="space-y-1">
