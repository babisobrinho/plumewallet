...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-l-8 border-plume-{{ $category->color }} flex flex-col justify-between h-full">
                <div>
                    ...
                    <div class="text-right mt-4">
                        <span class="text-lg font-semibold @if($category->type === 'expense') text-plume-red-500 @else text-plume-teal-500 @endif">
                            Total: R$ {{ number_format($category->transactions_sum_amount ?? 0, 2, ',', '.') }}
                        </span>
                    </div>
                </div>
                <div class="flex justify-end mt-4 space-x-4 border-t pt-4">
                    <a href="{{ route('categories.edit', $category) }}" class="text-plume-blue-500 hover:text-plume-blue-700 transition duration-300 ease-in-out text-xl" title="Editar">
