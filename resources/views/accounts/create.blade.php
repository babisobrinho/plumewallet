    ...
    <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="bg-plume-blue-600 dark:bg-plume-blue-700 px-6 py-4">
            <div class="flex items-center">
                ...
                <h2 class="text-2xl font-bold text-white">Nova Conta</h2>
            </div>
        </div>
        ...
        <form action="{{ route('accounts.store') }}" method="POST" class="p-6">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" id="name" 
                       ...
                       placeholder="Ex: Conta Principal, Poupança Bradesco..." value="{{ old('name') }}" required>
                @error('name')
            ...
            <!-- Saldo Inicial -->
            <div class="mb-6">
                <label for="balance" class="block text-plume-blue-600 dark:text-plume-blue-400 font-semibold mb-2">Saldo Inicial</label>
                <div class="relative">
                    <input type="number" name="balance" id="balance" 
                           ...
                           placeholder="0.00" value="{{ old('balance', '0.00') }}" step="0.01" min="0" required>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="color" value="bg-{{ $color }}" class="sr-only" {{ old('color') == 'bg-' . $color ? 'checked' : '' }}>
                ...
                <div class="flex space-x-6">
                    <label class="inline-flex items-center cursor-pointer">
                        <input type="radio" name="is_balance_effective" value="1" 
                               class="form-radio text-plume-blue-600 h-5 w-5" {{ old('is_balance_effective', '1') == '1' ? 'checked' : '' }}>
                    ...
                    <label class="inline-flex items-center cursor-pointer">
                        <input type="radio" name="is_balance_effective" value="0" 
                               class="form-radio text-plume-blue-600 h-5 w-5" {{ old('is_balance_effective') == '0' ? 'checked' : '' }}>
