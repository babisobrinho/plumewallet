                ...
                <form method="POST" action="{{ route('accounts.store') }}"
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               x-model="form.name"
                               required
                               class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-teal-500 focus:border-teal-500 dark:bg-gray-700 dark:text-gray-200 dark:placeholder-gray-400"
            ...
            function walletForm() {
                return {
                    form: {
                        ...
                        icon: '',
                        is_balance_effective: {{ json_encode(old('is_balance_effective', true)) }}
                    },

                    init() {
                        this.updateIcon();
                        // Garante que o valor seja booleano
                        this.form.is_balance_effective = this.form.is_balance_effective === true || this.form.is_balance_effective === 'true';
                    },
